...
export default class PlayerDisplay extends Component {
  ...
  update() {
    ...
    rc.path(body.scale(s).translate(100, 100).toString(), {stroke: '#424242'})
    rc.path(eye_left.scale(es).translate(100, 100).toString(), {'fill': 'black', roughness: 0.7, stroke: '#424242'})
